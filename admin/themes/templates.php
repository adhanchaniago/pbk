                        ...
                        <ul class="nav pull-right">
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Add
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?php echo web_root;?>admin/modules/lesson/index.php?view=add">Materi</a></li> 
                                </ul>
                            </li> 
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="<?php echo web_root; ?>admin/modules/lesson/index.php"><i class="menu-icon icon-bullhorn"></i>Materi</a>
                                </li>
                                <li><a href="<?php echo web_root; ?>admin/modules/exercises/index.php"><i class="menu-icon icon-inbox"></i>Latihan <b class="label green pull-right">
                                    11</b> </a></li> 
                            </ul>
                            <!--/.widget-nav-->
                            ...
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="<?php echo web_root; ?>admin/modules/modstudent/index.php"><i class="menu-icon icon-bold"></i> Management Siswa </a></li>
                                <li><a href="<?php echo web_root; ?>admin/modules/user/index.php"><i class="menu-icon icon-book"></i>Management User </a></li> 
                            </ul>
                            <!--/.widget-nav-->
                            <ul class="widget widget-menu unstyled"> 
